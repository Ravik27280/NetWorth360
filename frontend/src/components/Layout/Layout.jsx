  ...
  return (
    <div>
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
        ...
        <main>{children}</main>
        <footer className="mt-150 border-t border-black/5 dark:border-white/10">
          <div className="mx-auto max-w-7xl px-4 py-8 text-sm opacity-70 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">🔒 End-to-end encrypted • Real-time sync • © {new Date().getFullYear()} NetWorth360</div>
